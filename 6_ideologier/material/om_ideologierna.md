...
Tips: Denna sida har en funktion för markeringar och anteckningar via tjänsten hypothesis. Om man skapar en användare där sparas de markeringar ni gör. Om man inte skapar en användare, kommer dessa försvinna. Tänk dock på att alla markeringar och anteckningar som grundinställning är publika (med andra ord, alla kan se dem). Detta finns det både fördelar och nackdelar med. 
